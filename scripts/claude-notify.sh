...
# POPUP DISABLED: tmux popup commented out — Kitty icon + peon sound sufficient.
...
# Add to queue (disabled with popup)
...
# POPUP DISABLED — uncomment to re-enable tmux popup on permission prompts
